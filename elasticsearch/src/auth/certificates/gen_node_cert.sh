...
# previous: https://github.com/khezen/docker-elasticsearch/blob/master/src/auth/certificates/gen_node_cert.sh
...
keytool -genkey \
        ...
        -ext san=dns:$NODE_NAME,dns:localhost,ip:$(hostname -i),oid:1.2.3.4.5.5
